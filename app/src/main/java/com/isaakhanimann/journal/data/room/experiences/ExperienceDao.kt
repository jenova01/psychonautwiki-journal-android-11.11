...
interface ExperienceDao {
    ...
    @Query("SELECT time FROM ingestion WHERE substanceName = :substanceName ORDER BY time DESC LIMIT 1")
    suspend fun getLastUseDate(substanceName: String): Instant?
    ...
    @Query("SELECT * FROM customunit WHERE substanceName = :substanceName ORDER BY creationDate")
